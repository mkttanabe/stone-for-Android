...
package jp.klab.stone.certinstaller;
...
public class Credentials {
	...
	// KLab: replace 2 lines.
    //public static final String INSTALL_ACTION = "android.credentials.INSTALL";

    //public static final String SYSTEM_INSTALL_ACTION = "android.credentials.SYSTEM_INSTALL";

    public static final String INSTALL_ACTION = "jp.klab.stone.certinstaller.INSTALL";

    public static final String SYSTEM_INSTALL_ACTION = "jp.klab.stone.certinstaller.SYSTEM_INSTALL";
    ...
    private Intent createInstallIntent() {
        ...
        intent.setClassName("jp.klab.stone",
        		"jp.klab.stone.certinstaller.CertInstallerMain");
