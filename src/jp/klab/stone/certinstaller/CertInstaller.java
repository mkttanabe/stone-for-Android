...
// KLab: add 2 lines.
import jp.klab.stone.R;
import jp.klab.stone.stonePref;
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == REQUEST_SYSTEM_INSTALL_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                //setResult(RESULT_OK);
                Log.d(TAG, "credential is added: " + mCredentials.getName());
                stonePref pref = new stonePref(this);
                pref.SetParamHistory("-dd -q store=" + mCredentials.getName() + " SERVERNAME:443/ssl localhost:1443");
				Toast.makeText(this, getString(R.string.cert_is_added,
						mCredentials.getName()), Toast.LENGTH_LONG).show();
				setResult(RESULT_OK);
            } else {
